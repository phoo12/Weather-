...
import { ArrowLeft, Cloud, Droplets, Thermometer, Wind, Eye, Gauge } from "lucide-react";
        ...
        {loading ? (
          ...
          <div className="space-y-6">
              ...
              {weatherData.lastUpdated && (
                <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                  <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                    Last updated: {new Date(parseInt(weatherData.lastUpdated) * 1000).toLocaleString()}
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-6">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Weather data is updated every 10 minutes and sourced from OpenWeatherMap. 
                Data includes current conditions for {cityName}.
              </p>
            </div>
          </div>
        )}
